...
Not as mature as PFS, TFS definitely requires optimization and it is going to be part of the roadmap for this project. Below are the TFS features:
      ...
      4. Read and/or Limited write support. Files are cannot grow/shrink. And just like the PFS, 
         TFS will not mind Read-only & Hidden attributes. TFS works only with existing file
         and it has no facility to create or delete any file.
